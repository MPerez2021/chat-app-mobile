...
/*NATIVE BASE */
import { IconButton, Input, Text, useDisclose, Actionsheet, HStack, Box, useToast, Stack, Spinner, Heading } from 'native-base'
/*ICONS*/
...
const AllUsers = ({ route, navigation }) => {
    ...
    const LoadingSpinner = () => {
        return (
            ...
            <HStack space={2} justifyContent='center' style={styles.loadingSpinner}>
